...
namespace BattleSizeUnlocker
{
    ...
    public class ModSettings : SettingsBase
    {
        ...
        /// </summary>
        [XmlElement]
        [SettingProperty("Battle size", BattleSizeRuntime.MinimumBattleSize, BattleSizeRuntime.MaximumBattleSize, BattleSizeRuntime.MinimumBattleSize, BattleSizeRuntime.MaximumBattleSize, "This setting will override the actual battle size setting for the game.")]
